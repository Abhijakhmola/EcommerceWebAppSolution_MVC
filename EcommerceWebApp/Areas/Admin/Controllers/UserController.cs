...
namespace ECommerceWebApp.Areas.Admin.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        public IActionResult RoleManagment(RoleManagementVM roleManagmentVM)
        {
            ...
            {
                //a role was updated
                if (roleManagmentVM.ApplicationUser.Role == SD.Role_User_Company)
                {
            ...
            {
                if (oldRole == SD.Role_User_Company && applicationUser.CompanyId != roleManagmentVM.ApplicationUser.CompanyId)
                {
                    applicationUser.CompanyId = roleManagmentVM.ApplicationUser.CompanyId;
                    _unitOfWork.ApplicationUser.Update(applicationUser);
                    _unitOfWork.Save();
